# Generated by Django 2.1.7 on 2019-05-14 17:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ManyToManyField(related_name='group', to='account_app.UserGroup')),
            ],
        ),
        migrations.CreateModel(
            name='Combo',
        ...
        migrations.AddField(
            model_name='order',
            name='order_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orderUser', to=settings.AUTH_USER_MODEL),
        ),
    ]
